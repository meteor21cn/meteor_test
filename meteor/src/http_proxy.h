...
#define HTTP_REQUSET_HEADER_MAX_LENGTH		2048
...
struct http_response_s
{
	...
	int                 content_type;
	int                 connection;
	char                *response_header_content_length_start;
	char                *response_header_content_length_end;
	char                *response_header_content_type_start;
	char                *response_header_content_type_end;
	char                *response_header_transfer_encoding_start;
	char                *response_header_transfer_encoding_end;
	char                *response_header_connection_start;
	char                *response_header_connection_end;
};
