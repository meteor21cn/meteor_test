...
struct table_value_s formal_parse_header (struct table_value_s *t)
{
		char   ch, *h,*c;
		enum {
		sw_start = 0,
...
int parse_content_type_line(char *conten_type_value_top,char *conten_type_value_end){
	...
	if (_stristr(content_type_buf,"html")){
		return CONTENT_TYPE_HTML;
	}
	if (_stristr(content_type_buf,"m3u8")){
		return CONTENT_TYPE_M3U8;
	}
	return CONTENT_TYPE_OTHER;
}

int parse_connection_type_line(char *connection_value_top,char *connection_value_end){
