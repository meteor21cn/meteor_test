...
static meteor_command_t meteor_timer_commands[] = {
 ...
 static meteor_command_t meteor_worker_commands[] = {
    ...
    METEOR_CONF_TAKE1,
    meteor_conf_set_num,
    wk_offset(max_domains),
    NULL},

    {"max_passwds",
    METEOR_CONF_TAKE1,
    meteor_conf_set_num,
    wk_offset(max_passwds),
    NULL},
...
void print_config(socks_module_config_t *cf)
{
    ...
    for(i = 0;i<cf->workers;i++,wc++)
    {
        ...
        print_conf_int_value("max_domains",wc->max_domains);
        print_conf_int_value("max_passwds",wc->max_passwds);
    }
}
...
void meteor_conf_unset(socks_module_config_t *config)
{
    ...
    for (i = 0;i<MAX_WORKERS;i++,wc++)
    {
        ...
        wc->max_domains = METEOR_CONF_INT_UNSET;
        
        wc->max_passwds = METEOR_CONF_INT_UNSET;
